...
> = {
  en: {
    ...
    places: [
      { name: "Kukke Shri Subrahmanya Temple", description: "Famous Hindu temple in Subrahmanya, located 8.8 km from Shri Rama Temple.", image: P1 },
      { name: "Adi Subrahmanya Temple", description: "Dedicated to Lord Subrahmanya, worshipped in the form of an ant hill (valmika) for serpent-related afflictions, located 9.3 km from Shri Rama Temple.", image: P2 },
      { name: "Shri Subrahmanya Mutt", description: "A mutt belonging to the Dwaitha tradition, southeast of Kukke Shri Subrahmanya Temple, and 8.8 km from Shri Rama Temple. Oversees various temples, including the Shri Abhaya Ganapathi Temple and Sri Vanadurga Devi Temple.", image: P3 },
      { name: "Kashikatte Shri Ganapathi Temple", description: "Located beside the main road at Kashikatte in Subrahmanya, about 9.0 km from Shri Rama Temple. Includes temples of Ganapathi and Anjaneya.", image: P4 },
      { name: "Biladwara", description: "A historical cave, about 9.3 km from Shri Rama Temple, where Vasuki, the serpent king, is said to have hidden to escape from Garuda.", image: P5 },
      { name: "Shri Vanadurga Devi Temple", description: "Temple dedicated to Goddess Durga, about 9.6 km from Shri Rama Temple, known for daily poojas.", image: P6 },
      { name: "Shree Abhaya Mahaganapathi", description: "Located on the main road to Subrahmanya, 9.6 km from Shri Rama Temple. Features a 21-foot-tall monolithic statue of Lord Ganesha in Nepali style.", image: P7 },
      { name: "Agrahara Shri Somanatha Temple", description: "Known as Panchami Theertha, located 10.1 km from Shri Rama Temple, this temple is dedicated to Lord Shiva and serves as the entombment site of Shri Subrahmanya Mutt swamijis.", image: P8 },
      { name: "Shree Basaveshwara Temple", description: "This temple is 12.1 Km from Shri Rama Temple. Located 12.1 km from Shri Rama Temple in Kulkunda, just 2 km from Subrahmanya. Here, Lord Shiva is worshipped in the form of the sacred bull (Basava).", image: P9 },
      { name: "Kumaradhara River (Bathing Ghat)", description: "Traditional bathing ghat 10.3 km from Shri Rama Temple. Originates from Kumaraparvatha and joins the Arabian Sea.", image: P10 },
      { name: "Shri Kshethra Dharmasthala", description: "Major Hindu pilgrimage site dedicated to Lord Shiva, fostering religious harmony. Located 62.2 km from Shri Rama Temple.", image: P11 },
      { name: "Bisle Ghat Viewpoint", description: "Known for scenic views of Kumara Parvatha and the Western Ghats, located 32.4 km from Shri Rama Temple.", image: P12 },
      { name: "Patla Betta", description: "Picturesque hill in Sakleshpur, 40.5 km from Shri Rama Temple, ideal for trekking.", image: P13 },
      { name: "Mallalli Falls", description: "200-foot waterfall in Coorg, best visited during the monsoon, formed by the Kumaradhara River. Located 57.3 km from Shri Rama Temple.", image: P14 },
      { name: "Kumara Parvatha Trek", description: "Known as Pushpagiri, this challenging trek to the fourth-highest peak in the Western Ghats starts from the base camp in Kukke Subrahmanya, 10.1 km from Shri Rama Temple.", image: P15 },
      ...
      { name: "Shri Durgaparameshwari Temple,Marakatha", description: "Shri Durgaparameshwari Temple in Marakatha, Sullia Taluk, is a revered Hindu temple dedicated to Goddess Durga Parameshwari. Situated 25 km from Sullia and 9.1 km from Shri Rama Temple in Hariharapallathadka, it draws devotees seeking blessings and spiritual solace. Managed by local authorities, the temple hosts various rituals and festivals honoring the Goddess. For inquiries, please contact 08257 282166.", image: P17 },
      { name: "Shree Parivara Panchalingeshwara Temple, Panja", description: "Shree Parivara Panchalingeshwara Temple, located in Panja village along the Manjeshwara-Puttur-Subrahmanya state highway, is a historic Hindu temple dating back to the 13th century. According to local legends, the five Shiva Lingams enshrined here were installed by the Pandavas during their exile, linking the temple to the Mahabharata. Devotees visit to perform rituals like Rudrabhisheka, seeking blessings for marriage and relief from personal crises. The temple hosts annual events such as Brahmarathotsava and monthly rituals believed to eliminate various doshas. It is approximately 20.1 km from Shri Rama Temple. For more information, please contact the temple authorities at 08257 278355.", image: P18 },
    ],
  },
  kn: {
    title: "ಸಮೀಪದ ಸ್ಥಳಗಳು",
